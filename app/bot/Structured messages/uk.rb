...
def cta_country_message(sender)
  ...
  london_button.add_postback("View","London")
  ...
  manchester_button.add_postback("View","Manchester")
  ...
  glasgow_button.add_postback("View","Glasgow")
  ...
  edinburgh_button.add_postback("View","Edinburgh")
  ...
  birmingham_button.add_postback("View","Birmingham")
  ...
  newcastle_button.add_postback("View","Newcastle")
  ...
  bristol_button.add_postback("View","Bristol")
  ...
  belfast_button.add_postback("View","Belfast")
  ...
  brighton_button.add_postback("View","Brighton")
  ...
  liverpool_button.add_postback("View","Liverpool")
