...
def cta_country_message(sender)
  ...
  berlin_button.add_postback("View concerts in Berlin","Berlin")
  ...
  paris_button.add_postback("View concerts in Paris","Paris")
  ...
  amsterdam_button.add_postback("View concerts in Amsterdam","Amsterdam")
  ...
  barcelona_button.add_postback("View concerts in Barcelona","Barcelona")
  ...
  copenhagen_button.add_postback("View concerts in Copenhagen","Copenhagen")
  ...
  stockholm_button.add_postback("View concerts in Stockholm","Stockholm")
  ...
  dublin_button.add_postback("View concerts in Dublin","Dublin")
  ...
  prague_button.add_postback("View concerts in Prague","Prague")
  ...
  rome_button.add_postback("View concerts in Rome","Rome")
  ...
  budapest_button.add_postback("View concerts in Budapest","Budapest")
