...
def cta_country_message(sender)
  ...
  berlin_button.add_postback("View","Berlin")
  ...
  paris_button.add_postback("View","Paris")
  ...
  amsterdam_button.add_postback("View","Amsterdam")
  ...
  barcelona_button.add_postback("View","Barcelona")
  ...
  copenhagen_button.add_postback("View","Copenhagen")
  ...
  stockholm_button.add_postback("View","Stockholm")
  ...
  dublin_button.add_postback("View","Dublin")
  ...
  prague_button.add_postback("View","Prague")
  ...
  rome_button.add_postback("View","Rome")
  ...
  budapest_button.add_postback("View","Budapest")
