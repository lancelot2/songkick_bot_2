...
def cta_country_message(sender)
  ...
  san_francisco_button.add_postback("View","San Francisco")
  ...
  los_angeles_button.add_postback("View","Los Angeles")
  ...
  new_york_button.add_postback("View","New York")
  ...
  portland_button.add_postback("View","Portland")
  ...
  washington_button.add_postback("View","Washington")
  ...
  philadelphia_button.add_postback("View","Philadelphia")
  ...
  seattle_button.add_postback("View","Seattle")
  ...
  chicago_button.add_postback("View","Chicago")
  ...
  orlando_button.add_postback("View","Orlando")
  ...
  pittsburg_button.add_postback("View","Pittsburg")
