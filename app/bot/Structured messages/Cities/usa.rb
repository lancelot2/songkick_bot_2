...
def usa(sender)
  ...
  check_venues_in_san_francisco_button.add_postback("Venues in SF","sf")
  ...
  check_venues_in_new_york_button.add_postback("Venues in NYC","New York")
  ...
  check_venues_in_portland_button.add_postback("Venues in Portland","Portland")
  ...
  check_venues_in_washington_button.add_postback("Venues in Washington","Washington")
  ...
  check_venues_in_philadelphia_button.add_postback("Venues in Philly","Philadelphia")
  ...
  check_venues_in_seattle_button.add_postback("Venues in Seattle","Seattle")
  ...
  check_venues_in_chicago_button.add_postback("Venues in Chicago","Chicago")
  ...
  check_venues_in_orlando_button.add_postback("Venues in Orlando","Orlando")
