...
def europe(sender)
  ...
  check_venues_in_berlin_button.add_postback("Concerts in Berlin","Berlin")
  ...
  check_venues_in_paris_button.add_postback("Concerts in Paris","Paris")
  ...
  check_venues_in_amsterdam_button.add_postback("Concerts in Amsterdam","Amsterdam")
  ...
  check_venues_in_barcelona_button.add_postback("Concerts in Barcelona","Barcelona")
  ...
  check_venues_in_copenhagen_button.add_postback("Concerts in Copenhagen","Copenhagen")
  ...
  check_venues_in_stockholm_button.add_postback("Concerts in Stockholm","Stockholm")
  ...
  check_venues_in_dublin_button.add_postback("Concerts in Dublin","Dublin")
  ...
  check_venues_in_prague_button.add_postback("Concerts in Prague","Prague")
  ...
  check_venues_in_rome_button.add_postback("Concerts in Rome","Rome")
  ...
  check_venues_in_budapest_button.add_postback("Concerts in Budapest","Budapest")
