...
def uk(sender)
  ...
  check_venues_in_london_button.add_postback("Venues in London","London")
  ...
  check_venues_in_manchester_button.add_postback("Venues in Manchester","Manchester")
  ...
  check_venues_in_glasgow_button.add_postback("Venues in Glasgow","Glasgow")
  ...
  check_venues_in_edinburgh_button.add_postback("Venues in Edinburgh","Edinburgh")
  ...
  check_venues_in_birmingham_button.add_postback("Venues in Birmingham","Birmingham")
  ...
  check_venues_in_newcastle_button.add_postback("Venues in Newcastle","Newcastle")
  ...
  check_venues_in_bristol_button.add_postback("Venues in Bristol","Bristol")
  ...
  check_venues_in_belfast_button.add_postback("Venues in Belfast","Belfast")
  ...
  check_venues_in_brighton_button.add_postback("Venues in Brighton","Brighton")
